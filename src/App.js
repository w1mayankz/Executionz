...
export default function App() {
  ...
  return (
    <div
      className="min-h-screen selection:bg-[#CCCCCC] selection:text-black bg-white scroll-smooth"
      ...
      {activePage === "home" ? (
        <div key="home" className="slide-down-active">
            ...
            <main className="max-w-5xl mx-auto px-4 pt-24 font-['Inter_Tight']">
              ...
              <div className="mt-6 flex gap-1">
                <a
                  ...
                  className="px-3.5 py-2 rounded-full bg-[#0E78E8] text-white text-[12px] font-normal font-['Inter']"
                >
                  Get Started
                </a>

                <button className="px-3.5 py-2 rounded-full bg-[#313237] text-white text-[12px] font-normal font-['Inter']">
                  Testimonials
                </button>
              </div>
          ...
          >
            ...
            <div className="mt-24 w-full max-w-4xl mx-auto">
              ...
              <div className="relative min-h-[300px] px-4 md:px-0 font-['Inter_Tight']">
                {testimonials.map((testimonial, index) => (
                  ...
                  >
                    {/* Quote */}
                    <p className="pr-10 text-xl md:text-3xl lg:text-4xl text-black/40 font-medium leading-[1.3] tracking-tight mb-8">
            ...
            <div className="mt-24 w-full max-w-3xl mx-auto flex flex-col gap-4 md:px-0">
                <img 
                  src="/wxotwin.jpg"
