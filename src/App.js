  ...
  return (
    ...
    >
      <nav className="bg-[#191A1C] w-full sticky top-0 z-50 border-b border-[#313237] font-['Inter']">
        <div className="max-w-2xl md:max-w-4xl lg:max-w-2xl mx-auto w-full flex justify-between items-center py-2 px-5 lg:px-4 relative">
        <p
      ...
      {activePage === "home" ? (
        <div key="home" className="slide-down-active">
          <section id="home" className="bg-[#101115] scroll-mt-32 w-full pb-24">
            <main className="max-w-2xl md:max-w-4xl lg:max-w-2xl mx-auto px-4 pt-24 font-['Inter_Tight']">
